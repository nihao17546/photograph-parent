...
(function ($) {
    $.fn.simpleSlide = function (options) {
        ...
        var _defaults = {
            ...
            "windowAction": "fadeIn",
            "imageAction": "fadeIn",
            "loadingImage": "/static/img/timg.gif"
        ...
        //获取背景元素
        var _LOOK_BACK = $(".LookPicture_Background").eq(0);
        ...
        _THIS.on("click", function () {
            ...
            // var imgSrc = $($(this).context).attr('src');
            // RGBaster.colors(imgSrc, {
            //     success: function(payload) {
            //         var s=payload.dominant.replace(")",",0.5)");alert(s)
            //         _LOOK_BACK.css("background-color",s);
            //     }
            // });
            //显示主窗体
