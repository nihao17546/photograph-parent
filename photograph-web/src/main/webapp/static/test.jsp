...
<head>
    ...
    <link rel="shortcut icon" href="http://www.nihaov.com/static/img/favicon.ico">
    <link href="${contextPath}/static/libs/Flat-UI-master/bootstrap/css/bootstrap.css" rel="stylesheet">
    <link href="${contextPath}/static/libs/Flat-UI-master/css/flat-ui.css" rel="stylesheet">
</head>
<body>
<div class="container">
...
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery-1.8.3.min.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery-ui-1.10.3.custom.min.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery.ui.touch-punch.min.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/bootstrap.min.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/bootstrap-select.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/bootstrap-switch.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/flatui-checkbox.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/flatui-radio.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery.tagsinput.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery.placeholder.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/jquery.stacktable.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/video.js"></script>
<script src="${contextPath}/static/libs/Flat-UI-master/js/application.js"></script>
</body>
</html>
